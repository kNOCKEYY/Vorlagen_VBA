VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ufActivateSheet 
   Caption         =   "GoTo Sheet"
   ClientHeight    =   3090
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4710
   OleObjectBlob   =   "ufActivateSheet.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "ufActivateSheet"
