VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ufListMoveItems 
   Caption         =   "ListBox Move Item Demo"
   ClientHeight    =   2865
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3360
   OleObjectBlob   =   "ufListMoveItems.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "ufListMoveItems"
...
Private Sub cmdOK_Click()
    ...
    For i = 0 To Me.lbxItems.ListCount - 1
        Msg = Msg & Me.lbxItems.List(i) & vbNewLine
    Next i
    
    MsgBox "Moved Items: " & vbNewLine & Msg
