VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ufListBoxSelectRows 
   Caption         =   "Row Selector"
   ClientHeight    =   4290
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7605
   OleObjectBlob   =   "ufListBoxSelectRows.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "ufListBoxSelectRows"
...
Private Sub cmdOK_Click()
    ...
    For i = 0 To Me.lbxRange.ListCount - 1
        If Me.lbxRange.Selected(i) Then
            ...
            Else
                Set RowRange = Union(RowRange, _
                  ActiveSheet.UsedRange.Rows(i + 2))
            End If
        End If
    Next i
