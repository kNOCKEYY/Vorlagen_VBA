VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ufSizeChangeOnCmd 
   Caption         =   "Print Sheets"
   ClientHeight    =   2985
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5070
   OleObjectBlob   =   "ufSizeChangeOnCmd.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "ufSizeChangeOnCmd"
...
Const SmallSize As Integer = 128
