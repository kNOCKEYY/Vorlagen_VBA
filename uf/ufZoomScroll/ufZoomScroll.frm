VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ufZoomScroll 
   Caption         =   "Scroll & Zoom Demo"
   ClientHeight    =   2775
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3405
   OleObjectBlob   =   "ufZoomScroll.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "ufZoomScroll"
...
Private Sub scbColumns_Scroll()
    ActiveWindow.ScrollColumn = Me.scbColumns.Value
End Sub

Private Sub scbRows_Scroll()
